 ...
 * Generated at: 2017-10-18 07:58:33 UTC
...
return;
    ...
    try {
      ...
      out.write("\t    \t\t\t\t\t<br>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-row\">\n");
      out.write("\t\t\t\t\t\t        <label for=\"min\">Date Retour</label><br>\n");
      out.write("\t\t\t\t\t\t        <input class=\"min-today dateRet\" id=\"min\" type=\"date\" placeholder=\"YYYY-MM-DD\" data-date-split-input=\"false\" />\n");
      out.write("\t\t\t\t    \t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
 ...
 for( int i=0 ; i<list.size() ; i++ ){ 
      ...
      out.write("\t\t\tvar dateRet = (document.getElementsByClassName(\"dateRet\")[0].value);\n");
      out.write("\t\t\t\n");
      out.write("\t\t\ttab.forEach(function(element){\n");
      ...
      out.write("\t\t\tconsole.log(dateValide);\n");
      ...
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\twindow.location.href = \"http://localhost:8080/Projet/html_css/temp3.jsp?idgare1=\"+idgare1+\"&idgare2=\"+idgare2+\"&dateDep=\"+dateDep+\"&dateRet=\"+dateRet;\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t}else{\n");
      out.write("\t\t\t\t\n");
