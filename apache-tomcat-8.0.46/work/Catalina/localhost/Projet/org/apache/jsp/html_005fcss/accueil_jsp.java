 ...
 * Generated at: 2017-11-13 12:45:52 UTC
...
return;
 ...
 for( int i=0 ; i<list.size() ; i++ ){ 
      ...
      out.write("\t\t\tvar value1 = document.getElementById(\"trajet1\").value;\n");
      out.write("\t\t\tvar value2 = document.getElementById(\"trajet2\").value;\n");
      out.write("\t\t\t\n");
      out.write("\t\t\ttab.forEach(function(element){\n");
      out.write("\t\t\t\tif( element.includes(value1.substring(0,value1.indexOf(\"(\"))) ){\n");
      out.write("\t\t\t\t\tsessionStorage.setItem(\"gare1\",element.substring(0,element.indexOf(\"?\")));\n");
      out.write("\t\t\t\t}\n");
      out.write("\t\t\t\tif( element.includes(value2.substring(0,value2.indexOf(\"(\"))) ){\n");
      out.write("\t\t\t\t\tsessionStorage.setItem(\"gare2\",element.substring(0,element.indexOf(\"?\")));\n");
      out.write("\t\t\t\t}\n");
      out.write("\t\t\t});\n");
      out.write("\t\t\t\n");
      out.write("\t\t\tvar dateValide = (compareDate(dateDep,dateRet) == -1);\n");
      out.write("\n");
      out.write("\t\t\tif( value1 != \"\" && value2 != \"\" && dateDep !=\"\" && dateRet !=\"\" && sessionStorage.getItem(\"gare1\") != undefined && sessionStorage.getItem(\"gare2\") != undefined && dateValide ){\n");
      out.write("\t\t\t\t\n");
      out.write(" \t\t\t\twindow.location.href = \"http://localhost:8080/Projet/html_css/search.jsp?dateDep=\"+dateDep.toLocaleString(\"fr-FR\", {hour12: false})+\"&dateRet=\"+dateRet.toLocaleString(\"fr-FR\", {hour12: false});\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t}else{\n");
      out.write("\t\t\t\t\n");
